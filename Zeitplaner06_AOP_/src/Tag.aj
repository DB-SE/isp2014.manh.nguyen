...
public aspect Tag {
	final String featureName = "Tagesansicht (Timer, MonthChoice. YearChoice an- und abgewählt werden können)";
	...
	void around(ArrayList<String[]> features): k_Optionen(features){
		proceed(features);
		String fList[] = {"Tagesansicht (Timer, MonthChoice. YearChoice an- und abgewählt werden können)","Kalender"};
